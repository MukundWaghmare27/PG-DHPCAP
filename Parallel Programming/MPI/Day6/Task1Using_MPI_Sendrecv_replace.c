...
int main(){
    ...
    if(rank == 0){
        ...
        MPI_Sendrecv_replace(arr1, n, MPI_INT, 1, 0, 1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv_replace(arr1, n, MPI_INT, 0, 0, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
